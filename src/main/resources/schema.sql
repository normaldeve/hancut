...
create index if not exists idx_ai_article_keywords_article on ai_summary_keywords (ai_summary_id);
create index if not exists idx_ai_article_keywords_keyword on ai_summary_keywords (keyword);
...
CREATE INDEX idx_ai_summary_id ON reactions(ai_summary_id);
